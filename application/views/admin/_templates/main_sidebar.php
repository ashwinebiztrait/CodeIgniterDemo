...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('dashboard')?>">
                            <a href="<?php echo site_url('index.php/admin/dashboard'); ?>">
                        ...
                        <li class="<?=active_link_controller('groups')?>">
                            <a href="<?php echo site_url('index.php/admin/groups'); ?>">
                        ...
                        <li class="<?=active_link_controller('files')?>">
                            <a href="<?php echo site_url('index.php/admin/files'); ?>">
                                <i class="fa fa-file"></i> <span><?php echo lang('menu_files'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('database')?>">
                            <a href="<?php echo site_url('index.php/admin/database'); ?>">
